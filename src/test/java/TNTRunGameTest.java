...
import com.auroraschaos.minigames.game.TNTRunGame;
...
public class TNTRunGameTest {
    ...
    public void startTeleportsPlayersAndSetsScoreboard() throws Exception {
        ...
        TNTRunGame game = new TNTRunGame("TNT_RUN", GameMode.CLASSIC, plugin, arena, players);
        game.start();
